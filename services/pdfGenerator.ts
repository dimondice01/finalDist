...
// --- Funciones auxiliares de formato (TU CÓDIGO ORIGINAL) ---
...
// --- FUNCIÓN PRINCIPAL (TU CÓDIGO ORIGINAL) ---
export const generatePdf = async (
    ...
    const invoiceData = {
        ...
        // Tipo de comprobante (para el título)
        tipoComprobante: 
...
const generateHtml = (invoiceData: {
    ...
    tipoComprobante: string; // <-- Añadido
}) => {
    
    // Generar filas de la tabla de productos (TU CÓDIGO ORIGINAL)
   const itemsRows = invoiceData.items.map(item => { 
    ...
    // --- Definiciones de colores (TU CÓDIGO ORIGINAL) ---
    ...
    <html>
        <head>
            ...
            <style>
                ...
                /* ================================================== */
                /* --- 🔥 INICIO: ESTILOS DE INFO SUPERIOR --- */
                /* ================================================== */

                /* 🔥 NUEVO: Contenedor del Título Principal */
                .title-container {
                    text-align: center;
                    margin-bottom: 10px;
                    padding-bottom: 8px;
                    border-bottom: 1px solid ${primaryColor}; /* Borde del header original */
                }
                /* 🔥 NUEVO: Estilo del Título Principal */
                .main-title {
                    margin: 0;
                    font-size: 16px;
                    font-weight: 700;
                ...
                /* Contenedor de 3 columnas (SIN borde) */
                .top-info-container {
                    display: flex; 
                ...
                .distributor-info .distributor-details {
                    display: block;
                    font-size: 10px;
                    color: ${textSecondaryColor}; 
                }

                /* Col 2 y 3: (Estilos originales) */
                .details-block {
                    font-size: 10px;
                    line-height: 1.4;
                    flex: 1; 
                ...
                /* --- ANCHOS DE COLUMNA (TU CÓDIGO ORIGINAL) --- */
