...
const EditClientScreen = ({ navigation, route }: EditClientScreenProps) => {
    ...
    const handleSave = async () => {
        if (!formData.nombre) { Alert.alert("Campo Requerido", "El nombre del cliente es obligatorio."); return; }
        if (!formData.zonaId) { Alert.alert("Campo Requerido", "La zona es obligatoria."); return; }
