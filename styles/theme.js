...
export const COLORS = {
  ...
  backgroundStart: '#ffffffff', // Gris muy claro, casi blanco (Vanguardia - Gray-50)
  backgroundEnd: '#ffffffff',   // Gris más claro (Vanguardia - Gray-200)
  
  // --- COLOR PRINCIPAL (Azul Índigo Profundo para Profesionalismo) ---
  primary: '#700f0fff',       // Índigo Profundo (Tailwind 'indigo-600') - Base de Marca
  secondary:  "#072b77ff",
  ...
  textPrimary: '#090d14ff',    // Gris Oscuro/Casi Negro (Vanguardia - Gray-900)
  textSecondary: '#312e2eff',   // Gris medio para subtítulos (Vanguardia - Gray-500)
  ...
  glass: 'rgba(250, 255, 255, 1)', // Blanco casi opaco
  ...
  disabled: '#e8ecf3ff',      // Gris (Vanguardia - Gray-300)
};
